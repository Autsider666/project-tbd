...
import {
	...
	recruitSurvivor,
	upgradeSurvivor,
} from '../helper/SurvivorManagement.js';
...
export class ClientController {
	...
	private handleSurvivorManagement(): void {
		this.socket.on('survivor:upgrade', (data) =>
			upgradeSurvivor(data, this.socket.id)
		);

		this.socket.on('survivor:recruit', (data) =>
			recruitSurvivor(data, this.socket.id)
		);

		this.socket.on('survivor:dismiss', (data) =>
			dismissSurvivor(data, this.socket.id)
		);
	}
